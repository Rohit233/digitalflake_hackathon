...
class BookRoom extends StatefulWidget {
  ...
  const BookRoom({super.key,required this.slotBookingForm});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
       ...
       title: Text('Available rooms',style: Theme.of(context).textTheme.headline5,),
      ),
      body: Column(
        children: [
          Padding(
                              ...
                              GestureDetector(
                                    onTap: (() {
                                      if(workspace.workspaceActive) {
                                        ...
                                        BasicUtils.showSnackBar(context, 'This room is unavailable', SnackBarType.ERROR);
                                      }
